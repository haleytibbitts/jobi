...
import { BsBag, BsCheckSquare, BsClock } from "react-icons/bs";
...
const JobDetails = ({ jobs, curJob, setCurJob, isLoading, setIsLoading }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      onValue(dbRef, (response) => {
        ...
        setCurJob(newState.find((job) => job.id === pageId));
      });
      setIsLoading(false);
    } catch (error) {
      alert(error);
        ...
        <div className="wrapper">
          ...
          <section>
            ...
            <ul className="responsibilities">
              ...
              <li>
                <p>
                  Lead ideation sessions, workshops, demos, and presentations
                  with clients on-site
                </p>
              </li>
              <li>
                <p>
                  Establish design schedules, ensure final visual design
                  concepts are on-brand, on-budget, and deliver on product
                  strategy goals.
                </p>
              </li>
              <li>
                <p>
                  Collaborate with design peers to ensure designs are
                  conceptually sound
                </p>
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="skills">
              ...
              <li>
                <p>
                  You're empathetic to client needs and can help find solutions
                  if problems arise
                </p>
              </li>
              <li>
